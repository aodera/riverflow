...
<section class="what_you w3-about py-5">
		<div class="container py-md-4 mt-md-3">
			<h2 class="heading-agileinfo">Our  <span>Background</span></h2>
			<span class="w3-line black"></span>
			<div class="row about-info-grids mt-md-5 pt-5">
				<div class="col-lg-6 welcome-left">
					 <p style="text-align: left;"><?php echo $page->back_para1; ?> </p>
					 </br>
					 <p style="text-align: left;"> <?php echo $page->back_para2; ?> </p>
				 </div>
				 <div class="col-lg-6 welcome-right">
					<div class="welcome-right-top">
						<div class="well well-sm">  
							...
							<div id="body" >
								<p ><?php echo $page->back_vision; ?>  </p>
							</div>
							 
							<h4><b> MISSION</b></h4>
							<div id="body" >
								<p ><?php echo $page->back_mission; ?> </p>
							</div>
							 
							<h4><b> GOAL</b></h4>
							<div id="body" >
								<p ><?php echo $page->back_goal; ?> </p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row about-info-grids">
				<p style="text-align: left;"><?php echo $page->back_para3; ?>  </p>
