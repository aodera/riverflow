	...
	<section class="about-w3ls py-5">
		...
		<h2 class="heading-agileinfo">Our <span> Gallery</span></h2>
			<div class="row mt-md-5 pt-4">                
                  ...
                  <?php
                    foreach($page->album as $item) {
                        echo '<div class="col-lg-3 col-md-6 col-sm-6 team-grids">';  
                        echo '<div class="thumbnail team-agileits">';  
                        echo "<img class='img-fluid' src='{$item->gallery_image->url}{$item->gallery_image}' alt='Card image cap'>";
                        echo '</div>';
                        echo '</br>';
                        echo '</div>';
                    } 
