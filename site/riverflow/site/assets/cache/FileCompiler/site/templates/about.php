...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/22-10-2018/opsimathy_demo_Free/1469979633/web/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Oct 2018 22:03:16 GMT -->
		...
		<div class="container py-md-4 mt-md-3">
			...
			<div class="row about-info-grids mt-md-5 pt-5">
				<div class="col-lg-6 welcome-left">
					<h3>Welcome</h3>
					<p><?php echo $page->paragraph_one; ?> </p></br>
					<p><?php echo $page->paragraph_two; ?>  </p>
				</div>

				<div class="col-lg-6 welcome-right">
					<div class="welcome-right-top galleryimg">
                        <?php
                         foreach($page->about_image as $image){
                             echo "<img class='img-section4 img-fluid' src='{$image->url}' alt='place holder' />";
                         }                   
                        ?>  
						
                        </br></br></br>
                        <!--Help in making the the button link  -->
                        <div class="col-lg-3 w3layouts_getin gallerybutton">
                            <?php
			...
			<div class="row about-info-grids">
				<p><?php echo $page->paragraph_three; ?> </p></br>
				<p><?php echo $page->paragrah_four; ?> </p>
...
<!--	<section class="wthree-row w3-about py-5">
		<div class="container py-md-4 mt-md-3">
			...
			<div class="card-deck mt-md-5 pt-5">
                    ...
                    <?php
                        /*foreach($page->about_team as $item) {
                            echo '<div class="card">'; 
                            echo "<img class='img-fluid' src='{$item->about_teampic->url}{$item->about_teampic}' alt='Card image cap'>";
                            echo '<div class="card-body w3ls-card">';
                            echo '</br>';
                            echo "<h5 class='card-title'>$item->team_header</h5>";
                            echo '</div>';                            
                            echo '</div>';
                        } */
                        ?> 
...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/22-10-2018/opsimathy_demo_Free/1469979633/web/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Oct 2018 22:03:18 GMT -->
</html>